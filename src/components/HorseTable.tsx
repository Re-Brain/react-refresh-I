            ...
            {horses.map(horse => (
              ...
              >
                ...
                <td className="px-4 py-3">
                  <span
                    className={`inline-block text-xs font-bold px-2.5 py-1 rounded-full border ${HORSE_STATUS_STYLES[horse.status ?? 'approved']}`}
                  >
                    {HORSE_STATUS_LABELS[horse.status ?? 'approved']}
                  </span>
                </td>
                <td className="px-4 py-3">
