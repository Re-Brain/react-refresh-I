...
// Switches the main area between the Bookings, Subscription, and Settings
// sections. Below lg it's a fixed overlay drawer (with a backdrop) that
// slides in/out with `open`; at lg and up it's the original static column
// with the icon-rail collapse behaviour, unchanged.
