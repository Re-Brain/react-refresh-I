...
export const FARM_STATUS_STYLES: Record<'draft' | 'pending' | 'active' | 'rejected', string> = {
...
export const FARM_STATUS_LABELS: Record<'draft' | 'pending' | 'active' | 'rejected', string> = {
  draft: 'Draft',
